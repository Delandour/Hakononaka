...
define gui.accent_color = '#354abb'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#ffffffff'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#bdc1cc'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#354abb'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#4461fe'
...
## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#2b2b2bff'
...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/dialog.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/dialog.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/title_song3.ttf"
...
define gui.main_menu_background_te = "gui/overlay/true_end_title.png"
...
define gui.textbox_background = "images/dialog/dialog box.png"
...
## 0.5 来居中。
define gui.dialogue_xpos = 750
define gui.dialogue_pb_xpos = 400
define gui.dialogue_ypos = 30

## 对话文本的最大宽度，以像素为单位。
define gui.dialogue_width = 1150
define gui.dialogue_pb_width = 1400
...
## 快捷菜单按钮专用配置（新增部分）
## 为快捷按钮的不同状态设置背景图片，使用Frame()处理边框
define gui.quick_button_idle_background = Frame("quick_idle.png", 15, 6, 15, 0)  # 对应左侧、顶部、右侧、底部边框
define gui.quick_button_hover_background = Frame("quick_hover.png", 15, 6, 15, 0)
define gui.quick_button_selected_background = Frame("quick_selected.png", 15, 6, 15, 0)
define gui.quick_button_insensitive_background = Frame("quick_insensitive.png", 15, 6, 15, 0)

define gui.quick_button_borders = Borders(15, 6, 15, 0)
define gui.quick_button_text_size = 40
define gui.quick_button_text_idle_color = "#303139"
...
define gui.choice_button_text_idle_color = '#353434'
...
define gui.history_text_size = 28 # 设置历史对话文本字体大小为20
define gui.history_name_size = 34 # 设置历史对话中角色名字字体大小为24

## 所指定叙述角色的标签的坐标、宽度和对齐方式。
define gui.history_name_xpos = 0
define gui.history_name_ypos = 0.05
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(60, 21, 80, 20)
